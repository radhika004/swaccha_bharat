  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-background p-4">
      <header className="flex items-center justify-center mb-12">
        {/* Replace MountainIcon with a relevant icon if needed */}
      ...
      <main className="flex flex-col items-center text-center max-w-2xl mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-md">
          <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
            <Link href="/auth/citizen">
              I am a Citizen
            </Link>
          </Button>
          <Button asChild size="lg" variant="outline" className="border-primary text-primary hover:bg-primary/10 shadow-lg rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
